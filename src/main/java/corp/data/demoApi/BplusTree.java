...
public class BplusTree {
    ...
    private int binarySearch(DictionaryPair[] dps, int numPairs, long t) {
        ...
        return Arrays.binarySearch(dps, 0, numPairs, new DictionaryPair(t, new ClienteModel()), c);
    }
     ...
     */
    public void insert(long key, ClienteModel value){
        if (isEmpty()) {
     ...
     */
    public ClienteModel search(long key) {
     ...
     */
    public ArrayList<ClienteModel> search(long lowerBound, long upperBound) {

        // Instantiate Double array to hold values
        ArrayList<ClienteModel> values = new ArrayList<ClienteModel>();
    ...
    public class DictionaryPair implements Comparable<DictionaryPair> {
         ...
         */
        public DictionaryPair(long key, ClienteModel value) {
            this.key = key;
            this.value = value;
        }
